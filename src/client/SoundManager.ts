...
class SoundManager {
    ...
    public async loadSounds(sounds: { name: string, path: string }[]): Promise<void> {
    ...
    public unmute(): void {
        this.masterVolume.gain.setValueAtTime(this.userSettings.getVolume(), this.audioContext.currentTime);
        this.muted = false;
