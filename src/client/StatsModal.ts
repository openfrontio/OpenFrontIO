    ...
    if (this.error) {
      return html`
        <div class="flex flex-col items-center justify-center p-6 text-white">
          ...
          <button
            class="px-4 py-2 bg-red-600 hover:bg-red-700 rounded-sm text-sm font-medium"
  ...
  render() {
    ...
    return html`
      <div class="fixed top-20 right-4 z-[9998]">
        <button
          @click="${this.open}"
          class="w-12 h-12 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-2xl hover:shadow-2xl transition-all duration-200 flex items-center justify-center text-xl focus:outline-hidden focus:ring-4 focus:ring-red-500 focus:ring-offset-4"
