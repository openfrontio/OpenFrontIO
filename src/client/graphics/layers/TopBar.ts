...
export class TopBar extends LitElement implements Layer {
  ...
  render() {
    ...
    return html`
      <div
        class="fixed top-0 safe-top z-50 bg-gray-800/70 text-white text-sm p-1 rounded-ee-sm lg:rounded grid grid-cols-1 sm:grid-cols-2 w-1/2 sm:w-2/3 md:w-1/2 lg:hidden backdrop-blur"
      >
