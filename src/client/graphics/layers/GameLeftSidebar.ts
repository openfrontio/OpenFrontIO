...
export class GameLeftSidebar extends LitElement implements Layer {
  ...
  render() {
    return html`
      <aside
        class=${`fixed top-14 lg:top-4 left-2 z-[1000] flex flex-col max-h-[calc(100vh-80px)] overflow-y-auto py-2 px-3 bg-gray-800/70 backdrop-blur-sm shadow-xs rounded-lg transition-transform duration-300 ease-out transform ${
