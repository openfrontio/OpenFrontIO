...
export class GameRightSidebar extends LitElement implements Layer {
  ...
  render() {
    ...
    return html`
      <aside
        class=${`flex flex-row items-center gap-3 py-2 px-3 bg-gray-800/70 backdrop-blur-sm shadow-xs rounded-lg transition-transform duration-300 ease-out transform text-white ${
