    ...
    return html`
      <div class="flex items-center w-full h-full gap-2">
        <input
          ...
          maxlength="5"
          class="w-[6rem] bg-slate-900 border-b border-white/20 text-white placeholder-white text-xl font-bold text-center focus:outline-none focus:border-white/50 transition-colors uppercase shrink-0"
        />
        <input
          type="text"
          ...
          class="flex-1 min-w-0 bg-slate-900 border-0 text-white placeholder-white/30 text-2xl font-bold text-left focus:outline-none focus:ring-0 transition-colors overflow-x-auto whitespace-nowrap text-ellipsis pr-2"
        />
      </div>
