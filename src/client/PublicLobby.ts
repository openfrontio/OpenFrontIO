  ...
  render() {
    ...
    return html`
      <button
        ...
        class="isolate grid h-40 grid-cols-[1] grid-rows-[1] place-content-stretch w-full overflow-hidden ${this
          .isLobbyHighlighted
      ...
      >
        <img
          ...
          style="mask: linear-gradient(to left, transparent, #fff) alpha 0 0/100% 100%"
        />
        <div
