    ...
    return html`
      ...
      >
        ...
        >
          ...
          <div
            class="lg:hidden flex p-2 gap-2 bg-[color-mix(in_oklab,var(--frenchBlue)_75%,black)] w-full overflow-visible"
          >
            <!-- Left side: Two rows -->
            <div class="flex-1 flex flex-col gap-1 min-w-0">
              <!-- Row 1: Hamburger | Logo | Version -->
              <div class="flex items-center gap-2 h-10">
                ...
                <div
                  class="flex-1 flex items-center justify-center gap-2 text-[#2563eb] min-w-0"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span
                    class="game-version-display l-header__highlightText text-center"
                  ></span>
                </div>
              </div>
              <!-- Row 2: Username -->
            ...
            <!-- Right side: Skin button spanning both rows -->
            <pattern-input
