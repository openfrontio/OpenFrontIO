    ...
    return html`
      ...
      >
        ...
        <div class="relative">
          ...
          ></button>
          <span
            class="absolute top-1/2 -translate-y-1/2 right-4 bg-gradient-to-br from-red-600 to-red-700 text-white text-[10px] font-black tracking-wider px-2.5 py-1 rounded rotate-12 shadow-lg shadow-red-600/50 animate-pulse pointer-events-none"
          >
            NEW
          </span>
        </div>
