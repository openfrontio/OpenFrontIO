...
export class PatternInput extends LitElement {
  ...
  render() {
    ...
    return html`
      <button
        id="pattern-input_"
        class="pattern-btn m-0 border-0 bg-transparent hover:bg-white/10 w-full h-full flex cursor-pointer justify-center items-center focus:outline-none focus:ring-0 transition-all duration-200 hover:scale-105"
