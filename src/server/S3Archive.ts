...
export class S3Archive extends Archive {
  async archiveRecord(gameRecord: GameRecord) {
    try {
      ...
      // Archive to R2
      await this.archiveAnalyticsToR2(gameRecord);
      ...
      if (gameRecord.turns.length > 0) {
        ...
        await this.archiveFullGameToR2(gameRecord);
      }
    } catch (error) {
  ...
  async archiveAnalyticsToR2(gameRecord: GameRecord) {
  ...
  async archiveFullGameToR2(gameRecord: GameRecord) {
