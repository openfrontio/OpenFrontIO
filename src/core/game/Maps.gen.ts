...
export const maps: readonly MapInfo[] = [
  ...
  },
  {
    ...
    categories: ["europe", "new"],
    multiplayerFrequency: 5,
    customTribes: ["Aachen, Städteregion", "Ahrweiler", "Aichach-Friedberg", "Alb-Donau-Kreis", "Altenburger Land", "Altenkirchen (Westerwald)", "Altmarkkreis Salzwedel", "Altötting", "Alzey-Worms", "Amberg-Sulzbach", "Ammerland", "Anhalt-Bitterfeld", "Ansbach", "Aschaffenburg", "Augsburg", "Aurich", "Bad Dürkheim", "Bad Kissingen", "Bad Kreuznach", "Bad Tölz-Wolfratshausen", "Bamberg", "Barnim", "Bautzen", "Bayreuth", "Berchtesgadener Land", "Bergstraße", "Bernkastel-Wittlich", "Biberach", "Birkenfeld", "Böblingen", "Bodenseekreis", "Börde", "Borken", "Breisgau-Hochschwarzwald", "Burgenlandkreis", "Calw", "Celle", "Cham", "Cloppenburg", "Coburg", "Cochem-Zell", "Coesfeld", "Cuxhaven", "Dachau", "Dahme-Spreewald", "Darmstadt-Dieburg", "Deggendorf", "Diepholz", "Dillingen an der Donau", "Dingolfing-Landau", "Dithmarschen", "Donau-Ries", "Donnersbergkreis", "Düren", "Ebersberg", "Eichsfeld", "Eichstätt", "Eifelkreis Bitburg-Prüm", "Elbe-Elster", "Emmendingen", "Emsland", "Ennepe-Ruhr-Kreis", "Enzkreis", "Erding", "Erlangen-Höchstadt", "Erzgebirgskreis", "Esslingen", "Euskirchen", "Forchheim", "Freising", "Freudenstadt", "Freyung-Grafenau", "Friesland", "Fulda", "Fürstenfeldbruck", "Fürth", "Garmisch-Partenkirchen", "Germersheim", "Gießen", "Gifhorn", "Göppingen", "Görlitz", "Goslar", "Gotha", "Göttingen", "Grafschaft Bentheim", "Greiz", "Groß-Gerau", "Günzburg", "Gütersloh", "Hameln-Pyrmont", "Hannover, Region", "Harburg", "Harz", "Haßberge", "Havelland", "Heidekreis", "Heidenheim", "Heilbronn", "Heinsberg", "Helmstedt", "Herford", "Hersfeld-Rotenburg", "Herzogtum Lauenburg", "Hildburghausen", "Hildesheim", "Hochsauerlandkreis", "Hochtaunuskreis", "Hof", "Hohenlohekreis", "Holzminden", "Höxter", "Ilm-Kreis", "Jerichower Land", "Kaiserslautern", "Karlsruhe", "Kassel", "Kelheim", "Kitzingen", "Kleve", "Konstanz", "Kronach", "Kulmbach", "Kusel", "Kyffhäuserkreis", "Lahn-Dill-Kreis", "Landsberg am Lech", "Landshut", "Leer", "Leipzig", "Lichtenfels", "Limburg-Weilburg", "Lindau (Bodensee)", "Lippe", "Lörrach", "Lüchow-Dannenberg", "Ludwigsburg", "Ludwigslust-Parchim", "Lüneburg", "Main-Kinzig-Kreis", "Main-Spessart", "Main-Tauber-Kreis", "Main-Taunus-Kreis", "Mainz-Bingen", "Mansfeld-Südharz", "Marburg-Biedenkopf", "Märkischer Kreis", "Märkisch-Oderland", "Mayen-Koblenz", "Mecklenburgische Seenplatte", "Meißen", "Merzig-Wadern", "Mettmann", "Miesbach", "Miltenberg", "Minden-Lübbecke", "Mittelsachsen", "Mühldorf am Inn", "München", "Neckar-Odenwald-Kreis", "Neu-Ulm", "Neuburg-Schrobenhausen", "Neumarkt in der Oberpfalz", "Neunkirchen", "Neustadt an der Aisch-Bad Windsheim", "Neustadt an der Waldnaab", "Neuwied", "Nienburg/Weser", "Nordfriesland", "Nordhausen", "Nordsachsen", "Nordwestmecklenburg", "Northeim", "Nürnberger Land", "Oberallgäu", "Oberbergischer Kreis", "Oberhavel", "Oberspreewald-Lausitz", "Odenwaldkreis", "Oder-Spree", "Offenbach", "Oldenburg", "Olpe", "Ortenaukreis", "Osnabrück", "Ostalbkreis", "Ostallgäu", "Osterholz", "Ostholstein", "Ostprignitz-Ruppin", "Paderborn", "Passau", "Peine", "Pfaffenhofen an der Ilm", "Pinneberg", "Plön", "Potsdam-Mittelmark", "Prignitz", "Rastatt", "Ravensburg", "Recklinghausen", "Regen", "Regensburg", "Rems-Murr-Kreis", "Rendsburg-Eckernförde", "Reutlingen", "Rhein-Erft-Kreis", "Rheingau-Taunus-Kreis", "Rhein-Hunsrück-Kreis", "Rheinisch-Bergischer Kreis", "Rhein-Kreis Neuss", "Rhein-Lahn-Kreis", "Rhein-Neckar-Kreis", "Rhein-Pfalz-Kreis", "Rhein-Sieg-Kreis", "Rhön-Grabfeld", "Rosenheim", "Rostock", "Rotenburg (Wümme)", "Roth", "Rottal-Inn", "Rottweil", "Saale-Holzland-Kreis", "Saalekreis", "Saale-Orla-Kreis", "Saalfeld-Rudolstadt", "Saarbrücken, Regionalverband", "Saarlouis", "Saarpfalz-Kreis", "Sächsische Schweiz-Osterzgebirge", "Salzlandkreis", "Schaumburg", "Schleswig-Flensburg", "Schmalkalden-Meiningen", "Schwäbisch Hall", "Schwalm-Eder-Kreis", "Schwandorf", "Schwarzwald-Baar-Kreis", "Schweinfurt", "Segeberg", "Siegen-Wittgenstein", "Sigmaringen", "Soest", "Sömmerda", "Sonneberg", "Spree-Neiße", "St. Wendel", "Stade", "Starnberg", "Steinburg", "Steinfurt", "Stendal", "Stormarn", "Straubing-Bogen", "Südliche Weinstraße", "Südwestpfalz", "Teltow-Fläming", "Tirschenreuth", "Traunstein", "Trier-Saarburg", "Tübingen", "Tuttlingen", "Uckermark", "Uelzen", "Unna", "Unstrut-Hainich-Kreis", "Unterallgäu", "Vechta", "Verden", "Viersen", "Vogelsbergkreis", "Vogtlandkreis", "Vorpommern-Greifswald", "Vorpommern-Rügen", "Vulkaneifel", "Waldeck-Frankenberg", "Waldshut", "Warendorf", "Wartburgkreis", "Weilheim-Schongau", "Weimarer Land", "Weißenburg-Gunzenhausen", "Werra-Meißner-Kreis", "Wesel", "Wesermarsch", "Westerwaldkreis", "Wetteraukreis", "Wittenberg", "Wittmund", "Wolfenbüttel", "Wunsiedel im Fichtelgebirge", "Würzburg", "Zollernalbkreis", "Zwickau", "Aachen", "Amberg", "Baden-Baden", "Bielefeld", "Bochum", "Bonn", "Bottrop", "Brandenburg an der Havel", "Braunschweig", "Bremerhaven", "Chemnitz", "Cottbus", "Darmstadt", "Delmenhorst", "Dessau-Roßlau", "Dortmund", "Dresden", "Duisburg", "Düsseldorf", "Emden", "Erfurt", "Erlangen", "Essen", "Flensburg", "Frankenthal (Pfalz)", "Frankfurt (Oder)", "Frankfurt am Main", "Freiburg im Breisgau", "Gelsenkirchen", "Gera", "Hagen", "Halle (Saale)", "Hamm", "Hanau", "Hannover", "Heidelberg", "Herne", "Ingolstadt", "Jena", "Kaufbeuren", "Kempten (Allgäu)", "Kiel", "Koblenz", "Köln", "Krefeld", "Landau in der Pfalz", "Leverkusen", "Lübeck", "Ludwigshafen am Rhein", "Magdeburg", "Mainz", "Mannheim", "Memmingen", "Mönchengladbach", "Mülheim an der Ruhr", "Münster", "Neumünster", "Neustadt an der Weinstraße", "Nürnberg", "Oberhausen", "Offenbach am Main", "Oldenburg (Oldb)", "Pforzheim", "Pirmasens", "Potsdam", "Remscheid", "Salzgitter", "Schwabach", "Schwerin", "Solingen", "Speyer", "Straubing", "Stuttgart", "Suhl", "Trier", "Ulm", "Weiden in der Oberpfalz", "Weimar", "Wiesbaden", "Wilhelmshaven", "Wolfsburg", "Worms", "Wuppertal", "Zweibrücken", "Preußen", "Schwaben", "Franken", "Rheinland", "Westfalen", "Pommern", "Schleswig", "Holstein", "Anhalt", "Lausitz", "Elsass", "Deutscher Orden", "Nassau", "Kurpfalz", "Berg", "Jülich", "Lothringen", "Harzgau", "Wetterau", "Ruhrgebiet", "Allgäu", "Schwarzwald", "Spreewald", "Altmühltal", "Spessart", "Odenwald", "Eifel", "Sauerland", "Westerwald", "Pfalz"],
  },
  {
    id: "GiantWorldMap",
